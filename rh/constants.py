...
ESTRANGEIRO_NASCIMENTO_VALUE = 'EX'
ESTRANGEIRO_NASCIMENTO_LABEL = 'ESTRANGEIRO'
NATURALIDADE_ESTRANGEIRO = 'ESTRANGEIRO'

UF_NASCIMENTO_CHOICES = UF_CHOICES + [
    (ESTRANGEIRO_NASCIMENTO_VALUE, ESTRANGEIRO_NASCIMENTO_LABEL),
]
